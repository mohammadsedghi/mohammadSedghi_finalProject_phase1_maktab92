...
public class Specialist extends Person {
   ...
   String imageData;
    ...
    public Specialist(@NotNull(message = "this field must be have value")
                      ...
                      @Pattern(message = "province must be just letters",
                              regexp = "^[a-zA-Z]+$") String lastname,
                      @NotNull(message = "this field must be have value")
                      ...
                      @NotNull(message = "this field must be have value") LocalTime registerTime, Set<SubDuty> subDuties, Wallet wallet, SpecialistRegisterStatus status, String imageData) {
